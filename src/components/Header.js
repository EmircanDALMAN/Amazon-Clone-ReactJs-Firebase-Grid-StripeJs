      ...
      <header className={"sticky top-0 z-50"}>
         ...
         <div className={"flex items-center bg-amazon_blue p-1 flex-grow py-2"}>
            <div className={"mt-2 flex items-center flex-grow sm:flex-grow-0"}>
               <Image src={"https://links.papareact.com/f90"} className={"cursor-pointer"}
            ...
            {/*  Search Bar */}
            <div
               className={"hidden sm:flex items-center rounded-md flex-grow cursor-pointer h-10 bg-yellow-400 hover:bg-yellow-500"}>
               <input type="text"
            ...
            <div className={"text-white flex items-center text-xs space-x-6 mx-6 whitespace-nowrap"}>
               ...
               <div onClick={() => router.push("/checkout")} className={"link relative flex items-center"}>
                  <span
                     className={"absolute top-0 right-0 md:right-10 h-4 w-4 bg-yellow-400 text-center rounded-full text-black font-bold"}>{items.length}</span>
